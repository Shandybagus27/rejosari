...
@section('contents')
    ...
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar jenis pengunjung</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('dashboard.jns_paket.create') }}">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Jenis Paket</th>
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Diskon</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('dashboard.jns_paket.edit', $item->id) }}"
                                        class="btn btn-warning btn-sm"><span><i
                                                class="fa-solid fa-pen-to-square"></i></span></a>

                                    <form action="{{ route('dashboard.jns_paket.delete', $item->id) }}" method="post"
                                        class="d-inline">
                                        @method('delete')
                                        @csrf
