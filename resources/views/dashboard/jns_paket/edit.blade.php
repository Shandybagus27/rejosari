...
@section('contents')
    <div class="py-12">
        <h1>Halaman edit data jenis pengunjung</h1>
    </div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                {{-- from tambah data --}}
                <div class="col-lg-8">
                    <form method="post" action="{{ route('dashboard.jns_paket.update', $jenis->id) }}" class="mt-6 space-y-6"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="jns_paket" type="text"
                                    ...
                                    value="{{ $jenis->jns_paket }}" placeholder="Nama paket wisata" required autofocus>
                                @error('jns_paket')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="diskon" type="float"
                                    ...
                                    value="{{ $jenis->diskon }}" placeholder="Tentukan diskon" required autofocus>
                                @error('diskon')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
