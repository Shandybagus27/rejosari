...
@section('contents')
    ...
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar Barang</h1>
    </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Harga</th>
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Stok</th>
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Keterangan</th>
                            {{-- <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">gambar</th> --}}
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td class="text-center">
                                    <img src="{{ url('uploads') }}/{{ $barang->gambar }}" width="100">
                                </td> --}}
