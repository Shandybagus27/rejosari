    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 mt-4">
        <div class="col">
          <div class="card h-100">
            <img src="img/padi.jpg" width="500" height="250" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="img/jagung.jpeg" width="500" height="250" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="img/durian.jpg" width="500" height="250" class="card-img-top" alt="...">
            <div class="card-body">
