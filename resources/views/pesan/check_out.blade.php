...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ url('warung') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i>
                        Kembali</a>
                </div>
                <div class="col-md-12 mt-2">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('warung') }}">Home</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (!empty($pesanan))
                                {{-- <p align="right">Tanggal Pesan : {{ \Carbon\Carbon::parse($pesanan->tanggal)->format('d M Y') }}</p> --}}
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            {{-- <th>Gambar</th> --}}
                                            <th class="text-sm text-left text-gray-900 px-20 py-15 text-center">Nama Barang</th>
                                            <th class="text-sm text-left text-gray-900 px-20 py-15 text-center">Jumlah</th>
                                            <th class="text-sm text-left text-gray-900 px-20 py-15 text-center">Harga</th>
                                            <th class="text-sm text-left text-gray-900 px-20 py-15 text-center">Total Harga</th>
                                            <th class="text-sm text-left text-gray-900 px-20 py-15 text-center">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($pesanan_details as $key => $item)
                                        <tr>
                                            {{-- <td>{{ $no++ }}</td> --}}
                                            ...
                                            {{-- <td> --}}
                                                {{-- <img src="{{ url('uploads') }}/{{ $pesanan_detail->barang->gambar }}"
                                                        width="100" alt="..."> --}}
                                            {{-- </td> --}}
                                            <td class="text-sm text-gray-900 font-light px-10 py-6 whitespace-nowrap text-center">{{ $item->barang->nama_barang }}</td>
                                            {{-- <td>{{ $pesanan_detail->barang->nama_barang }}</td> --}}
                                            <td>{{ $item->jumlah }}</td>
                                            <td align="right">Rp. 20000
                                            </td>
                                            {{-- <td align="right">Rp.
                                                    {{ number_format($pesanan_detail->barangs->harga) }}</td> --}}
                                            <td align="right">Rp. 1000000
                                            </td>
                                            {{-- <td align="right">Rp.
